...
wget "https://raw.githubusercontent.com/jua74470/repo/41d072d926799d46111c4b51246d62c03607997b/CentOs/6/remi/php56/php56/php56.spec" -qO "$(rpm --eval '%{_specdir}')/php56.spec"
