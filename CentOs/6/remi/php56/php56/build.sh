...
wget "https://raw.githubusercontent.com/jua74470/repo/d78e5d8eaedeee92324aee6160518c858f18a7d3/CentOs/6/remi/php56/php56/php56.spec" -qO "$(rpm --eval '%{_specdir}')/php56.spec"
