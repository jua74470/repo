...
wget "https://raw.githubusercontent.com/jua74470/repo/e0e9f28c7c1a5f324ad554eafe118527436c5157/CentOs/6/remi/php56/php56/php56.spec" -qO "$(rpm --eval '%{_specdir}')/php56.spec"
