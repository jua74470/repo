...
wget "https://raw.githubusercontent.com/jua74470/repo/614e0e30a168bb90b0b9201440763dccbd575698/CentOs/6/remi/php56/php56/php56.spec" -qO "$(rpm --eval '%{_specdir}')/php56.spec"
