...
wget "https://raw.githubusercontent.com/jua74470/repo/37cbdd7feb4980cde3fd35cae3fac2753b451117/CentOs/6/remi/php56/php56/php56.spec" -qO "$(rpm --eval '%{_specdir}')/php56.spec"
